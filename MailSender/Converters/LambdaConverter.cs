...
namespace MailSender.Converters
{
    ...
    public class LambdaConverter : ValueConverter
    {
        ...
        public override object ConvertBack(object v, Type t, object p, CultureInfo c) => (_From ?? throw new NotSupportedException("Обратное преобразование не поддерживается")).Invoke(v,t,p,c);
    }
}